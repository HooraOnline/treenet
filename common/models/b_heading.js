...
module.exports = function(Model) {
  ...
  Model.add =  (data, callback)=>{
    ...
    let entity={
      ...
      specialUnitList:data.specialUnitList,
      buildingId:1,
      ownerFactor:data.ownerFactor || 0,
      ownerUnitFactor:data.ownerUnitFactor|| 0,
      ownerNumberFactor:data.ownerNumberFactor|| 0,
      ownerMetersFactor:data.ownerMetersFactor|| 0,
      ownerFloorFactor:data.ownerFloorFactor|| 0,

      residentFactor:data.residentFactor|| 0,
      residentUnitFactor:data.residentUnitFactor|| 0,
      residentNumberFactor:data.residentNumberFactor|| 0,
      residentMetersFactor:data.residentMetersFactor|| 0,
      residentFloorFactor:data.residentFloorFactor|| 0,
